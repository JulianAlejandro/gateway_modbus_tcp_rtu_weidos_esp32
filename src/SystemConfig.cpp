...
// Se cambia el tipo de retorno a uint32_t para no perder los bits altos de la configuración de la ESP32
uint32_t parseSerialConfig(const char* str) {
    ...
    // Default por si el string no coincide o está vacío
    return SERIAL_8N1; 
}
